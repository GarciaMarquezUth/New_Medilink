...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('citas', function (Blueprint $table) {
            if (! Schema::hasColumn('citas', 'estado_pago')) {
                $table->string('estado_pago')->default(Cita::PAGO_PENDIENTE)->after('estado');
            }
            ...
            if (! Schema::hasColumn('citas', 'metodo_pago')) {
                $table->string('metodo_pago')->nullable()->after('monto_pagado');
            }
        });
    }
    ...
    {
        Schema::table('citas', function (Blueprint $table) {
            foreach (['metodo_pago', 'monto_pagado', 'estado_pago'] as $column) {
